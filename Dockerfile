...
RUN DEBIAN_FRONTEND=noninteractive sudo apt-get -qy update && \
	sudo apt-get -qy install lsb-release apt-utils git libxml2-utils bash-completion ca-certificates build-essential
